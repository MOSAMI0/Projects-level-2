...
{
	cout << "\n____________Round [" << RoundInfo.RoundNumbers << "]____________\n\n";
...
stGameResult FillGameResults(int GameRound, short Player1WinTimes, short ComputerWinTimes, short DrawTimes)
{
...
{
	cout << Tabs(2) << "_____________________ [Game Results]______________________\n\n";
